    ...
    <div class="max-w-4xl mx-auto space-y-6">
      ...
      <div class="bg-white rounded-xl p-6 border border-slate-200">
        <div class="flex items-center gap-6">
          <div class="w-24 h-24 bg-gradient-to-br from-purple-600 to-pink-600 rounded-2xl flex items-center justify-center text-white text-4xl font-bold">
          ...
          <div class="flex-1">
            ...
            <div class="mt-2">
              <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium"
                    [class]="authService.user()?.role === 'master' ? 'bg-purple-100 text-purple-700' : 
                            authService.user()?.role === 'admin' ? 'bg-blue-100 text-blue-700' : 
        ...
        <form (ngSubmit)="updateName()" class="space-y-4">
          <div>
            ...
            <input
              ...
              name="name"
              required
              class="w-full px-4 py-2 rounded-lg border border-slate-300 focus:outline-none focus:ring-2 focus:ring-purple-500"
